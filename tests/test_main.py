...
def _activity_stub(id, visibility="public", sport_type="Run",
                   start_date="2024-03-15T08:00:00Z", name="Morning Run"):
...
class TestMain:
    ...
    def test_full_run_writes_report_and_prints_summary(self, monkeypatch, tmp_path, capsys):
        ...
        responses.add(responses.GET, ACTIVITIES_URL, json=[
        ...
        responses.add(responses.GET, "https://www.strava.com/api/v3/activities/1",
                      json=_detail_stub(1, pr=True), status=200)
        responses.add(responses.GET, "https://www.strava.com/api/v3/activities/2",
                      json=_detail_stub(2, pr=False), status=200)
